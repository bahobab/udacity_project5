...
***PLEASE SEE THE 'requirements.txt' FOR ALL THE PYTHON LIBRAIRIES AND THEIR VERSIONS USED FOR THIS PROJECT
...
LIMITATIONS:
============
In this project I did not check for duplicated books with same titles, isbn, author names etc... It could be fixed later
